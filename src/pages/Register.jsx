        ...
        <form className='min-h-[80vh] flex items-center'>
          <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
            ...
            <div className='w-full '>
              ...
              <input className='border border-zinc-300 rounded w-full p-2 mt-1' type="email" id='name' name='name' placeholder="Digite o seu nome completo."/>
            </div>
            <div className='w-full '>
            ...
            <p>Já tem uma conta? <span className='text-primary underline cursor-pointer' onClick={() =>{navigate("/login")}}>Clique aqui.</span></p>
          </div>
